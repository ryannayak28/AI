...
burglary = (int(input("Burglary Happened ?\t===>\t")))
check = 0 
while check != 1:
    if burglary == 1 :
        check = 1
        ...
        burglary = (int(input("Wrong input, Burglary Happened ?\t===>\t")))
earthquake = (int(input("Earthquake Happened ?\t===>\t")))
check = 0
while check != 1:
    if earthquake == 1 :
        check = 1
        ...
        earthquake = (int(input("Wrong input, Earthquake Happened ?\t===>\t")))
alarm = (int(input("Alarm Rang ?\t\t===>\t")))
check = 0
while check != 1:
    if alarm == 1 :
        check = 1
        ...
        alarm = (int(input("Wrong input, Alarm Rang ?\t===>\t")))
davidcall = (int(input("David Called ?\t\t===>\t")))
check = 0
while check != 1:
    if davidcall == 1 :
        check = 1
        ...
        davidcall = (int(input("Wrong input, David Called ?\t===>\t")))
sophiacall = (int(input("Sophia Called ?\t\t===>\t")))
check = 0
while check != 1:
    if sophiacall == 1 :
        check = 1
        ...
        sophiacall = (int(input("Wrong input, Sophia Called ?\t===>\t")))
